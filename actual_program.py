...
def interests(age):
    ...
    if calculations == "1":
        rate = int(input("What rate would you like to calculate? "))
        year = int(input("At what year would you like to withdraw the interest money? "))
        principal = int(input("How much money would you like to add as your principal? "))
        c_interest = principal * rate * (year-2025)
        final_age = (year-(2025-age))
        print(f"By the time you are {final_age}, you will have {c_interest} in your account.")
    elif calculations == "2":
        rate = int(input("What rate would you like to calculate? "))
        year = int(input("At what year would you like to withdraw the interest money? "))
        principal = int(input("How much money would you like to add as your principal? "))
